      ...
      <div class="container justify-content-center">
        ...
        >
          <a class="nav-brand" href="/">
            <img src="@/assets/insta-logo.png" alt="" loading="lazy" />
          </a>
      ...
      <div class="col-9">
        <div class="row">
                ...
                <div class="card-body p-0">
                  ...
                  <div class="ps-3 pe-3 pb-2">
                    ...
                    <span>
                      ...
                      Accusantium minus, tempore eaque dolorem officiis velit
                      aut quaerat alias, voluptate rerum eos error aliquid.
                      Nobis omnis optio qui accusantium. Nobis, doloribus.
                    </span>
                    ...
                    <div>
                      ...
                      <div class="mb-1">
                        <strong class="me-2">heex.x</strong>
                        <span>😧😧ㅋㅋㅋㅋ</span>
                      </div>
                    </div>
                    <small class="text-muted">varialble HOUR AGO</small>
                  </div>
                  <!-- feed-comments-views end -->

                  <!-- feed-comment-input start -->
                  <div class="position-relative comment-box">
                    <form>
                      ...
                      />
                      <button class="btn btn-primary position-absolute btn-ig">
                        Post
                      </button>
                    </form>
                  </div>
                  <!-- feed-comment-input end -->
                </div>
                <!-- feed-content end -->
              </div>
            </div>
          ...
          <div class="col-4">
            ...
            <div class="d-flex flex-row align-items-center">
              <div
                class="rounded-circle overflow-hidden d-flex justify-content-conter align-items-center border side-profile-photo me-3"
              >
                <img
                  src="@/assets/cat1.jpg"
                  style="
